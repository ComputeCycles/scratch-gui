...
const openMQTTMenu = () => openMenu(MENU_MQTT);
const closeMQTTMenu = () => closeMenu(MENU_MQTT);
const mqttMenuOpen = state => state.scratchGui.menus[MENU_MQTT];
