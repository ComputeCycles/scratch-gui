...
import WebBTButtonComponent from '../components/webbt-button/webbt-button';
...
class MQTTButton extends React.Component {
    ...
    playSound (soundName) {
        ...
        const audio = new Audio(`https://cdn.assets.scratch.mit.edu/internalapi/asset/${ext.md5ext}/get`);
